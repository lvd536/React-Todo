...
export default function DetailsModal() {
  ...
  return (
    <div className="flex font-second fixed items-center justify-center w-screen h-screen bg-gray-500/30 z-2">
      <div className="flex text-black dark:text-white relative flex-col items-center w-2/6 bg-white dark:bg-black ring-white dark:rind-black ring-1 rounded-xl gap-5 py-5 px-10 animate-modal">
