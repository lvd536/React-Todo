  ...
  return (
    <div className="flex items-center justify-between gap-10" key={todo.id}>
      <div className="flex gap-10 items-center">
        <input type="checkbox" name="isCompleted" id="isCompleted" className="appearance-none w-5 h-5 ring-1 ring-indigo-500 rounded-xs checked:bg-indigo-500 transition-colors duration-200" checked={todo.completed} onChange={() => toggleTodo(todo.id)}/>
